    ...
    <div className="flex flex-col items-center w-full max-w-[267px] mx-auto">
        ...
        <div className="flex flex-col h-[205px] items-center justify-start overflow-clip pb-0 pt-4 px-0 relative w-[265px]">
          ...
          <div className="flex items-center justify-between px-8 py-0 relative shrink-0 w-full">
            <div className="flex gap-2.5 items-center justify-center overflow-clip pb-4 pt-0 px-0 relative shrink-0">
              <span className="font-['Inter:Regular',_sans-serif] font-normal text-[#707173] text-[14px]">Swap</span>
            </div>
            <div className="flex gap-2.5 items-center justify-center overflow-clip pb-4 pt-0 px-0 relative shrink-0">
              <div className="flex gap-1 items-center justify-start relative shrink-0">
                ...
                <span className="font-['Inter:Regular',_sans-serif] font-normal text-[#ffffff] text-[14px]">$4503</span>
              </div>
              <div className="bg-[rgba(29,129,71,0.2)] flex gap-[7.829px] h-5 items-center justify-center px-[15.659px] py-[9.395px] relative rounded-[782.156px] shrink-0 w-11 border border-[#1d8147]">
                <span className="font-['Inter:Medium',_sans-serif] font-medium text-[#d3ffca] text-[10px]">MAX</span>
              </div>
            </div>
          </div>
          ...
          <div className="flex h-[70px] items-center justify-between overflow-clip p-[32px] relative shrink-0 w-full">
            <div className="flex gap-3.5 items-center justify-start relative shrink-0">
              <div className="flex h-[26px] items-end justify-end pl-0 pr-3 py-0 relative shrink-0 w-[30px]">
                <div className="mr-[-12px] relative shrink-0 size-9">
                  <div className="absolute bottom-[5.56%] left-[33.33%] right-0 top-[27.78%]">
                ...
                <div className="absolute bg-[#ffffff] bottom-[-2px] flex gap-2 items-center justify-start p-[2px] right-[-4px] rounded-[1000px] border border-[#ffffff] shadow-[0px_1px_1px_-0.5px_rgba(0,0,0,0.04),0px_3px_3px_-1.5px_rgba(0,0,0,0.04)]">
              ...
              <div className="flex flex-col gap-2.5 items-center justify-start leading-[0] not-italic relative shrink-0">
                <span className="font-['Inter:Medium',_sans-serif] font-medium text-[#ffffff] text-[12px] w-full leading-[36.092px]">Dai</span>
                <span className="font-['Inter:Regular',_sans-serif] font-normal text-[#707173] text-[8px] w-full leading-[36.092px]">Gnosis</span>
              </div>
            </div>
            <div className="flex flex-col gap-2.5 items-end justify-center leading-[0] not-italic relative shrink-0 text-right">
              <span className="font-['Inter:Medium',_sans-serif] font-medium text-[#ffffff] text-[12px] w-full leading-[36.092px]">1020.20</span>
              <span className="font-['Inter:Regular',_sans-serif] font-normal text-[#707173] text-[8px] w-full leading-[36.092px]">$1020.01</span>
            </div>
          </div>
          ...
          <div className="flex h-[70px] items-center justify-between overflow-clip p-[32px] relative shrink-0 w-full">
            <div className="flex gap-3.5 items-center justify-start relative shrink-0">
              ...
              <div className="flex flex-col gap-2.5 items-center justify-start leading-[0] not-italic relative shrink-0">
                <span className="font-['Inter:Medium',_sans-serif] font-medium text-[#ffffff] text-[16px] w-full leading-[36.092px]">Uni</span>
                <span className="font-['Inter:Regular',_sans-serif] font-normal text-[#707173] text-[12px] w-full leading-[36.092px]">Gnosis</span>
              </div>
            </div>
            <div className="flex flex-col gap-2.5 items-end justify-center leading-[0] not-italic relative shrink-0 text-right">
              <span className="font-['Inter:Medium',_sans-serif] font-medium text-[#ffffff] text-[16px] w-full leading-[36.092px]">400.25</span>
              <span className="font-['Inter:Regular',_sans-serif] font-normal text-[#707173] text-[12px] w-full leading-[36.092px]">$1020.01</span>
            </div>
          </div>
          ...
          <div className="absolute bg-[#111315] flex items-center justify-center px-2 py-[6.667px] rounded-[6666px] size-7 top-[110px] translate-x-[-50%]" style={{ left: "calc(50% + 0.5px)" }}>
            <svg width="12" height="13.333" viewBox="0 0 12 13.333" fill="none">
              <path d="M6 2.66667L6 10.6667M6 2.66667L3.33333 6M6 2.66667L8.66667 6" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
              <path d="M6 10.6667L6 2.66667M6 10.6667L3.33333 7.33333M6 10.6667L8.66667 7.33333" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
          </div>
        </div>
      ...
      >
        <div className="box-border content-stretch flex gap-2 items-center justify-center px-5 py-3 relative shrink-0">
          ...
          <div className="font-['Inter:Semi_Bold',_sans-serif] font-semibold leading-[0] not-italic relative shrink-0 text-[#ffffff] text-[14px] text-nowrap">
            <p className="leading-[36.092px] whitespace-pre">
      ...
      {transactionState === 'error' && errorMessage && (
        <div className="mt-2 p-2 bg-red-900/20 border border-red-600 rounded-lg w-full">
          <p className="text-red-400 text-[10px]">{errorMessage}</p>
        </div>
      )}
      
      {transactionState === 'success' && (
        <div className="mt-2 p-2 bg-green-900/20 border border-green-600 rounded-lg w-full">
          <p className="text-green-400 text-[10px]">Transaction completed successfully!</p>
        </div>
      )}
    </div>
  );
